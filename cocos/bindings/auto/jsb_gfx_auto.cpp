...
static bool js_gfx_GFXObject_getObjectID(se::State& s)
{
...
static bool js_gfx_GFXObject_getObjectType(se::State& s)
{
    auto* cobj = SE_THIS_OBJECT<cc::gfx::GFXObject>(s);
...
static bool js_gfx_GFXObject_getTypedID(se::State& s)
{
    auto* cobj = SE_THIS_OBJECT<cc::gfx::GFXObject>(s);
...
static bool js_gfx_Context_getColorFormat(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        auto result = static_cast<int>(cobj->getColorFormat());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
...
static bool js_gfx_Context_getDepthStencilFormat(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        auto result = static_cast<int>(cobj->getDepthStencilFormat());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
...
static bool js_gfx_DescriptorSet_getLayout(se::State& s)
{
    auto* cobj = SE_THIS_OBJECT<cc::gfx::DescriptorSet>(s);
...
static bool js_gfx_DescriptorSetLayout_getDynamicBindings(se::State& s)
{
    auto* cobj = SE_THIS_OBJECT<cc::gfx::DescriptorSetLayout>(s);
...
static bool js_gfx_Sampler_getAddressU(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        auto result = static_cast<int>(cobj->getAddressU());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
...
static bool js_gfx_Sampler_getAddressV(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        auto result = static_cast<int>(cobj->getAddressV());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
...
static bool js_gfx_Sampler_getAddressW(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        auto result = static_cast<int>(cobj->getAddressW());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
...
static bool js_gfx_Sampler_getCmpFunc(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        auto result = static_cast<int>(cobj->getCmpFunc());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
...
static bool js_gfx_Sampler_getMagFilter(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        auto result = static_cast<int>(cobj->getMagFilter());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
...
static bool js_gfx_Sampler_getMinFilter(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        auto result = static_cast<int>(cobj->getMinFilter());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
...
static bool js_gfx_Sampler_getMipFilter(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        auto result = static_cast<int>(cobj->getMipFilter());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
...
static bool js_gfx_Texture_getSamples(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        auto result = static_cast<int>(cobj->getSamples());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
