...
static bool js_pipeline_DeferredPipeline_getEmptyDescriptorset(se::State& s) // NOLINT(readability-identifier-naming)
{
    auto* cobj = SE_THIS_OBJECT<cc::pipeline::DeferredPipeline>(s);
    SE_PRECONDITION2(cobj, false, "js_pipeline_DeferredPipeline_getEmptyDescriptorset : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cc::gfx::DescriptorSet* result = cobj->getEmptyDescriptorset();
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_pipeline_DeferredPipeline_getEmptyDescriptorset : Error processing arguments");
        SE_HOLD_RETURN_VALUE(result, s.thisObject(), s.rval());
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
...
SE_BIND_FUNC(js_pipeline_DeferredPipeline_getEmptyDescriptorset)
...
bool js_register_pipeline_DeferredPipeline(se::Object* obj) // NOLINT(readability-identifier-naming)
{
    ...
    cls->defineFunction("getEmptyDescriptorset", _SE(js_pipeline_DeferredPipeline_getEmptyDescriptorset));
...
static bool js_pipeline_BloomStage_getCombineDS(se::State& s) // NOLINT(readability-identifier-naming)
{
    auto* cobj = SE_THIS_OBJECT<cc::pipeline::BloomStage>(s);
    SE_PRECONDITION2(cobj, false, "js_pipeline_BloomStage_getCombineDS : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cc::gfx::DescriptorSet* result = cobj->getCombineDS();
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_pipeline_BloomStage_getCombineDS : Error processing arguments");
        SE_HOLD_RETURN_VALUE(result, s.thisObject(), s.rval());
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
...
SE_BIND_FUNC(js_pipeline_BloomStage_getCombineDS)

static bool js_pipeline_BloomStage_getDownsampelGlobalUBO(se::State& s) // NOLINT(readability-identifier-naming)
{
    auto* cobj = SE_THIS_OBJECT<cc::pipeline::BloomStage>(s);
    SE_PRECONDITION2(cobj, false, "js_pipeline_BloomStage_getDownsampelGlobalUBO : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cc::gfx::Buffer** result = cobj->getDownsampelGlobalUBO();
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_pipeline_BloomStage_getDownsampelGlobalUBO : Error processing arguments");
        SE_HOLD_RETURN_VALUE(result, s.thisObject(), s.rval());
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
...
SE_BIND_FUNC(js_pipeline_BloomStage_getDownsampelGlobalUBO)

static bool js_pipeline_BloomStage_getDownsampleDS(se::State& s) // NOLINT(readability-identifier-naming)
{
    auto* cobj = SE_THIS_OBJECT<cc::pipeline::BloomStage>(s);
    SE_PRECONDITION2(cobj, false, "js_pipeline_BloomStage_getDownsampleDS : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cc::gfx::DescriptorSet** result = cobj->getDownsampleDS();
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_pipeline_BloomStage_getDownsampleDS : Error processing arguments");
        SE_HOLD_RETURN_VALUE(result, s.thisObject(), s.rval());
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
...
SE_BIND_FUNC(js_pipeline_BloomStage_getDownsampleDS)

static bool js_pipeline_BloomStage_getPrefilterDS(se::State& s) // NOLINT(readability-identifier-naming)
{
    auto* cobj = SE_THIS_OBJECT<cc::pipeline::BloomStage>(s);
    SE_PRECONDITION2(cobj, false, "js_pipeline_BloomStage_getPrefilterDS : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cc::gfx::DescriptorSet* result = cobj->getPrefilterDS();
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_pipeline_BloomStage_getPrefilterDS : Error processing arguments");
        SE_HOLD_RETURN_VALUE(result, s.thisObject(), s.rval());
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
...
SE_BIND_FUNC(js_pipeline_BloomStage_getPrefilterDS)
...
static bool js_pipeline_BloomStage_getUpsampleDS(se::State& s) // NOLINT(readability-identifier-naming)
{
    auto* cobj = SE_THIS_OBJECT<cc::pipeline::BloomStage>(s);
    SE_PRECONDITION2(cobj, false, "js_pipeline_BloomStage_getUpsampleDS : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cc::gfx::DescriptorSet** result = cobj->getUpsampleDS();
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_pipeline_BloomStage_getUpsampleDS : Error processing arguments");
        SE_HOLD_RETURN_VALUE(result, s.thisObject(), s.rval());
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
...
SE_BIND_FUNC(js_pipeline_BloomStage_getUpsampleDS)

static bool js_pipeline_BloomStage_getUpsampleGlobalUBO(se::State& s) // NOLINT(readability-identifier-naming)
{
    auto* cobj = SE_THIS_OBJECT<cc::pipeline::BloomStage>(s);
    SE_PRECONDITION2(cobj, false, "js_pipeline_BloomStage_getUpsampleGlobalUBO : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cc::gfx::Buffer** result = cobj->getUpsampleGlobalUBO();
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_pipeline_BloomStage_getUpsampleGlobalUBO : Error processing arguments");
        SE_HOLD_RETURN_VALUE(result, s.thisObject(), s.rval());
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
...
SE_BIND_FUNC(js_pipeline_BloomStage_getUpsampleGlobalUBO)
...
bool js_register_pipeline_BloomStage(se::Object* obj) // NOLINT(readability-identifier-naming)
{
    ...
    cls->defineFunction("getCombineDS", _SE(js_pipeline_BloomStage_getCombineDS));
    cls->defineFunction("getDownsampelGlobalUBO", _SE(js_pipeline_BloomStage_getDownsampelGlobalUBO));
    cls->defineFunction("getDownsampleDS", _SE(js_pipeline_BloomStage_getDownsampleDS));
    cls->defineFunction("getPrefilterDS", _SE(js_pipeline_BloomStage_getPrefilterDS));
    cls->defineFunction("getSampler", _SE(js_pipeline_BloomStage_getSampler));
    cls->defineFunction("getUpsampleDS", _SE(js_pipeline_BloomStage_getUpsampleDS));
    cls->defineFunction("getUpsampleGlobalUBO", _SE(js_pipeline_BloomStage_getUpsampleGlobalUBO));
