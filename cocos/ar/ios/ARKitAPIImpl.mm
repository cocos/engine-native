...
- (int *)getRemovedPlanesInfo {
    int *planesInfo = (int *)malloc(sizeof(int) * kPlanesInfoSize * mRemovedPlanes.count);
    int  n          = 0;
...
- (void)addRefWithAnchor:(ARAnchor *)anchor {
    ...
    [mAnchorsRefMap setObject:[NSNumber numberWithUnsignedInteger:ref]
                       forKey:anchor];
}
