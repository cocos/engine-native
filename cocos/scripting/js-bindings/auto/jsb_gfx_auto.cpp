...
se::Object* __jsb_cc_gfx_Binding_proto = nullptr;
se::Class* __jsb_cc_gfx_Binding_class = nullptr;

static bool js_gfx_Binding_get_shaderStages(se::State& s)
{
    cc::gfx::Binding* cobj = (cc::gfx::Binding*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_Binding_get_shaderStages : Invalid Native Object");
...
SE_BIND_PROP_GET(js_gfx_Binding_get_shaderStages)

static bool js_gfx_Binding_set_shaderStages(se::State& s)
{
    const auto& args = s.args();
    cc::gfx::Binding* cobj = (cc::gfx::Binding*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_Binding_set_shaderStages : Invalid Native Object");

    CC_UNUSED bool ok = true;
    cc::gfx::ShaderType arg0;
    do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cc::gfx::ShaderType)tmp; } while(false);
    SE_PRECONDITION2(ok, false, "js_gfx_Binding_set_shaderStages : Error processing new value");
    cobj->shaderStages = arg0;
    return true;
}
SE_BIND_PROP_SET(js_gfx_Binding_set_shaderStages)

static bool js_gfx_Binding_get_binding(se::State& s)
{
    cc::gfx::Binding* cobj = (cc::gfx::Binding*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_Binding_get_binding : Invalid Native Object");
...
SE_BIND_PROP_GET(js_gfx_Binding_get_binding)

static bool js_gfx_Binding_set_binding(se::State& s)
{
    const auto& args = s.args();
    cc::gfx::Binding* cobj = (cc::gfx::Binding*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_Binding_set_binding : Invalid Native Object");

    CC_UNUSED bool ok = true;
    unsigned int arg0 = 0;
    ok &= seval_to_uint32(args[0], (uint32_t*)&arg0);
    SE_PRECONDITION2(ok, false, "js_gfx_Binding_set_binding : Error processing new value");
    cobj->binding = arg0;
    return true;
}
SE_BIND_PROP_SET(js_gfx_Binding_set_binding)

static bool js_gfx_Binding_get_type(se::State& s)
{
    cc::gfx::Binding* cobj = (cc::gfx::Binding*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_Binding_get_type : Invalid Native Object");
...
SE_BIND_PROP_GET(js_gfx_Binding_get_type)

static bool js_gfx_Binding_set_type(se::State& s)
{
    const auto& args = s.args();
    cc::gfx::Binding* cobj = (cc::gfx::Binding*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_Binding_set_type : Invalid Native Object");

    CC_UNUSED bool ok = true;
    cc::gfx::BindingType arg0;
    do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cc::gfx::BindingType)tmp; } while(false);
    SE_PRECONDITION2(ok, false, "js_gfx_Binding_set_type : Error processing new value");
    cobj->type = arg0;
    return true;
}
SE_BIND_PROP_SET(js_gfx_Binding_set_type)

static bool js_gfx_Binding_get_name(se::State& s)
{
    cc::gfx::Binding* cobj = (cc::gfx::Binding*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_Binding_get_name : Invalid Native Object");
...
SE_BIND_PROP_GET(js_gfx_Binding_get_name)

static bool js_gfx_Binding_set_name(se::State& s)
{
    const auto& args = s.args();
    cc::gfx::Binding* cobj = (cc::gfx::Binding*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_Binding_set_name : Invalid Native Object");

    CC_UNUSED bool ok = true;
    cc::String arg0;
    arg0 = args[0].toStringForce().c_str();
    SE_PRECONDITION2(ok, false, "js_gfx_Binding_set_name : Error processing new value");
    cobj->name = arg0;
    return true;
}
SE_BIND_PROP_SET(js_gfx_Binding_set_name)

static bool js_gfx_Binding_get_count(se::State& s)
{
    cc::gfx::Binding* cobj = (cc::gfx::Binding*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_Binding_get_count : Invalid Native Object");
...
SE_BIND_PROP_GET(js_gfx_Binding_get_count)

static bool js_gfx_Binding_set_count(se::State& s)
{
    const auto& args = s.args();
    cc::gfx::Binding* cobj = (cc::gfx::Binding*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_Binding_set_count : Invalid Native Object");

    CC_UNUSED bool ok = true;
    unsigned int arg0 = 0;
    ok &= seval_to_uint32(args[0], (uint32_t*)&arg0);
    SE_PRECONDITION2(ok, false, "js_gfx_Binding_set_count : Error processing new value");
    cobj->count = arg0;
    return true;
}
SE_BIND_PROP_SET(js_gfx_Binding_set_count)

SE_DECLARE_FINALIZE_FUNC(js_cc_gfx_Binding_finalize)

static bool js_gfx_Binding_constructor(se::State& s)
{
    CC_UNUSED bool ok = true;
    const auto& args = s.args();
    size_t argc = args.size();
    ...
    if(argc == 0) 
    {
        cc::gfx::Binding* cobj = JSB_ALLOC(cc::gfx::Binding);
        s.thisObject()->setPrivateData(cobj);
        se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
        return true;
    }
...
SE_BIND_CTOR(js_gfx_Binding_constructor, __jsb_cc_gfx_Binding_class, js_cc_gfx_Binding_finalize)




static bool js_cc_gfx_Binding_finalize(se::State& s)
{
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(s.nativeThisObject());
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
...
SE_BIND_FINALIZE_FUNC(js_cc_gfx_Binding_finalize)

bool js_register_gfx_Binding(se::Object* obj)
{
    auto cls = se::Class::create("Binding", obj, nullptr, _SE(js_gfx_Binding_constructor));

    cls->defineProperty("shaderStages", _SE(js_gfx_Binding_get_shaderStages), _SE(js_gfx_Binding_set_shaderStages));
    cls->defineProperty("binding", _SE(js_gfx_Binding_get_binding), _SE(js_gfx_Binding_set_binding));
    cls->defineProperty("type", _SE(js_gfx_Binding_get_type), _SE(js_gfx_Binding_set_type));
    cls->defineProperty("name", _SE(js_gfx_Binding_get_name), _SE(js_gfx_Binding_set_name));
    cls->defineProperty("count", _SE(js_gfx_Binding_get_count), _SE(js_gfx_Binding_set_count));
    cls->defineFinalizeFunction(_SE(js_cc_gfx_Binding_finalize));
    cls->install();
    JSBClassType::registerClass<cc::gfx::Binding>(cls);

    __jsb_cc_gfx_Binding_proto = cls->getProto();
    __jsb_cc_gfx_Binding_class = cls;
...
static bool js_gfx_BindingLayoutInfo_get_bindings(se::State& s)
{
    cc::gfx::BindingLayoutInfo* cobj = (cc::gfx::BindingLayoutInfo*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_BindingLayoutInfo_get_bindings : Invalid Native Object");
...
SE_BIND_PROP_GET(js_gfx_BindingLayoutInfo_get_bindings)

static bool js_gfx_BindingLayoutInfo_set_bindings(se::State& s)
{
    const auto& args = s.args();
    cc::gfx::BindingLayoutInfo* cobj = (cc::gfx::BindingLayoutInfo*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_BindingLayoutInfo_set_bindings : Invalid Native Object");

    CC_UNUSED bool ok = true;
    std::vector<cc::gfx::Binding> arg0;
    ok &= seval_to_std_vector(args[0], &arg0);
    SE_PRECONDITION2(ok, false, "js_gfx_BindingLayoutInfo_set_bindings : Error processing new value");
    cobj->bindings = arg0;
    return true;
}
SE_BIND_PROP_SET(js_gfx_BindingLayoutInfo_set_bindings)
...
bool js_register_gfx_BindingLayoutInfo(se::Object* obj)
{
    ...
    cls->defineProperty("bindings", _SE(js_gfx_BindingLayoutInfo_get_bindings), _SE(js_gfx_BindingLayoutInfo_set_bindings));
...
se::Object* __jsb_cc_gfx_PushConstantRange_proto = nullptr;
se::Class* __jsb_cc_gfx_PushConstantRange_class = nullptr;

static bool js_gfx_PushConstantRange_get_shaderType(se::State& s)
{
    cc::gfx::PushConstantRange* cobj = (cc::gfx::PushConstantRange*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_PushConstantRange_get_shaderType : Invalid Native Object");
...
SE_BIND_PROP_GET(js_gfx_PushConstantRange_get_shaderType)

static bool js_gfx_PushConstantRange_set_shaderType(se::State& s)
{
    const auto& args = s.args();
    cc::gfx::PushConstantRange* cobj = (cc::gfx::PushConstantRange*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_PushConstantRange_set_shaderType : Invalid Native Object");

    CC_UNUSED bool ok = true;
    cc::gfx::ShaderType arg0;
    do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (cc::gfx::ShaderType)tmp; } while(false);
    SE_PRECONDITION2(ok, false, "js_gfx_PushConstantRange_set_shaderType : Error processing new value");
    cobj->shaderType = arg0;
    return true;
}
SE_BIND_PROP_SET(js_gfx_PushConstantRange_set_shaderType)

static bool js_gfx_PushConstantRange_get_offset(se::State& s)
{
    cc::gfx::PushConstantRange* cobj = (cc::gfx::PushConstantRange*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_PushConstantRange_get_offset : Invalid Native Object");
...
SE_BIND_PROP_GET(js_gfx_PushConstantRange_get_offset)

static bool js_gfx_PushConstantRange_set_offset(se::State& s)
{
    const auto& args = s.args();
    cc::gfx::PushConstantRange* cobj = (cc::gfx::PushConstantRange*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_PushConstantRange_set_offset : Invalid Native Object");

    CC_UNUSED bool ok = true;
    unsigned int arg0 = 0;
    ok &= seval_to_uint32(args[0], (uint32_t*)&arg0);
    SE_PRECONDITION2(ok, false, "js_gfx_PushConstantRange_set_offset : Error processing new value");
    cobj->offset = arg0;
    return true;
}
SE_BIND_PROP_SET(js_gfx_PushConstantRange_set_offset)

static bool js_gfx_PushConstantRange_get_count(se::State& s)
{
    cc::gfx::PushConstantRange* cobj = (cc::gfx::PushConstantRange*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_PushConstantRange_get_count : Invalid Native Object");
...
SE_BIND_PROP_GET(js_gfx_PushConstantRange_get_count)

static bool js_gfx_PushConstantRange_set_count(se::State& s)
{
    const auto& args = s.args();
    cc::gfx::PushConstantRange* cobj = (cc::gfx::PushConstantRange*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_PushConstantRange_set_count : Invalid Native Object");

    CC_UNUSED bool ok = true;
    unsigned int arg0 = 0;
    ok &= seval_to_uint32(args[0], (uint32_t*)&arg0);
    SE_PRECONDITION2(ok, false, "js_gfx_PushConstantRange_set_count : Error processing new value");
    cobj->count = arg0;
    return true;
}
SE_BIND_PROP_SET(js_gfx_PushConstantRange_set_count)

SE_DECLARE_FINALIZE_FUNC(js_cc_gfx_PushConstantRange_finalize)

static bool js_gfx_PushConstantRange_constructor(se::State& s)
{
    CC_UNUSED bool ok = true;
    const auto& args = s.args();
    size_t argc = args.size();
    ...
    if(argc == 0) 
    {
        cc::gfx::PushConstantRange* cobj = JSB_ALLOC(cc::gfx::PushConstantRange);
        s.thisObject()->setPrivateData(cobj);
        se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
        return true;
    }
...
SE_BIND_CTOR(js_gfx_PushConstantRange_constructor, __jsb_cc_gfx_PushConstantRange_class, js_cc_gfx_PushConstantRange_finalize)




static bool js_cc_gfx_PushConstantRange_finalize(se::State& s)
{
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(s.nativeThisObject());
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
...
SE_BIND_FINALIZE_FUNC(js_cc_gfx_PushConstantRange_finalize)

bool js_register_gfx_PushConstantRange(se::Object* obj)
{
    auto cls = se::Class::create("PushConstantRange", obj, nullptr, _SE(js_gfx_PushConstantRange_constructor));

    cls->defineProperty("shaderType", _SE(js_gfx_PushConstantRange_get_shaderType), _SE(js_gfx_PushConstantRange_set_shaderType));
    cls->defineProperty("offset", _SE(js_gfx_PushConstantRange_get_offset), _SE(js_gfx_PushConstantRange_set_offset));
    cls->defineProperty("count", _SE(js_gfx_PushConstantRange_get_count), _SE(js_gfx_PushConstantRange_set_count));
    cls->defineFinalizeFunction(_SE(js_cc_gfx_PushConstantRange_finalize));
    cls->install();
    JSBClassType::registerClass<cc::gfx::PushConstantRange>(cls);

    __jsb_cc_gfx_PushConstantRange_proto = cls->getProto();
    __jsb_cc_gfx_PushConstantRange_class = cls;
...
static bool js_gfx_PipelineLayoutInfo_get_pushConstantsRanges(se::State& s)
{
    cc::gfx::PipelineLayoutInfo* cobj = (cc::gfx::PipelineLayoutInfo*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_PipelineLayoutInfo_get_pushConstantsRanges : Invalid Native Object");
...
SE_BIND_PROP_GET(js_gfx_PipelineLayoutInfo_get_pushConstantsRanges)

static bool js_gfx_PipelineLayoutInfo_set_pushConstantsRanges(se::State& s)
{
    const auto& args = s.args();
    cc::gfx::PipelineLayoutInfo* cobj = (cc::gfx::PipelineLayoutInfo*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_PipelineLayoutInfo_set_pushConstantsRanges : Invalid Native Object");

    CC_UNUSED bool ok = true;
    std::vector<cc::gfx::PushConstantRange> arg0;
    ok &= seval_to_std_vector(args[0], &arg0);
    SE_PRECONDITION2(ok, false, "js_gfx_PipelineLayoutInfo_set_pushConstantsRanges : Error processing new value");
    cobj->pushConstantsRanges = arg0;
    return true;
}
SE_BIND_PROP_SET(js_gfx_PipelineLayoutInfo_set_pushConstantsRanges)

static bool js_gfx_PipelineLayoutInfo_get_layouts(se::State& s)
{
    cc::gfx::PipelineLayoutInfo* cobj = (cc::gfx::PipelineLayoutInfo*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_PipelineLayoutInfo_get_layouts : Invalid Native Object");
...
SE_BIND_PROP_GET(js_gfx_PipelineLayoutInfo_get_layouts)

static bool js_gfx_PipelineLayoutInfo_set_layouts(se::State& s)
{
    const auto& args = s.args();
    cc::gfx::PipelineLayoutInfo* cobj = (cc::gfx::PipelineLayoutInfo*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_PipelineLayoutInfo_set_layouts : Invalid Native Object");

    CC_UNUSED bool ok = true;
    std::vector<cc::gfx::BindingLayout *> arg0;
    ok &= seval_to_std_vector(args[0], &arg0);
    SE_PRECONDITION2(ok, false, "js_gfx_PipelineLayoutInfo_set_layouts : Error processing new value");
    cobj->layouts = arg0;
    return true;
}
SE_BIND_PROP_SET(js_gfx_PipelineLayoutInfo_set_layouts)
...
static bool js_gfx_PipelineLayoutInfo_constructor(se::State& s)
{
    ...
    else if(argc == 1 && args[0].isObject())
    {
        ...
        std::vector<cc::gfx::BindingLayout *> arg1;
...
bool js_register_gfx_PipelineLayoutInfo(se::Object* obj)
{
    ...
    cls->defineProperty("pushConstantsRanges", _SE(js_gfx_PipelineLayoutInfo_get_pushConstantsRanges), _SE(js_gfx_PipelineLayoutInfo_set_pushConstantsRanges));
    cls->defineProperty("layouts", _SE(js_gfx_PipelineLayoutInfo_get_layouts), _SE(js_gfx_PipelineLayoutInfo_set_layouts));
...
static bool js_gfx_PipelineStateInfo_get_layout(se::State& s)
{
    cc::gfx::PipelineStateInfo* cobj = (cc::gfx::PipelineStateInfo*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_PipelineStateInfo_get_layout : Invalid Native Object");
...
SE_BIND_PROP_GET(js_gfx_PipelineStateInfo_get_layout)

static bool js_gfx_PipelineStateInfo_set_layout(se::State& s)
{
    const auto& args = s.args();
    cc::gfx::PipelineStateInfo* cobj = (cc::gfx::PipelineStateInfo*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_PipelineStateInfo_set_layout : Invalid Native Object");

    CC_UNUSED bool ok = true;
    cc::gfx::PipelineLayout* arg0 = nullptr;
    ok &= seval_to_native_ptr(args[0], &arg0);
    SE_PRECONDITION2(ok, false, "js_gfx_PipelineStateInfo_set_layout : Error processing new value");
    cobj->layout = arg0;
    return true;
}
SE_BIND_PROP_SET(js_gfx_PipelineStateInfo_set_layout)
...
static bool js_gfx_PipelineStateInfo_constructor(se::State& s)
{
    ...
    else if(argc == 1 && args[0].isObject())
    {
        ...
        cc::gfx::PipelineLayout* arg7 = nullptr;
        json->getProperty("layout", &field);
        if(!field.isUndefined()) {
            ok &= seval_to_native_ptr(field, &arg7);
            cobj->layout = arg7;
        }
        cc::gfx::RenderPass* arg8 = nullptr;
        json->getProperty("renderPass", &field);
        if(!field.isUndefined()) {
...
bool js_register_gfx_PipelineStateInfo(se::Object* obj)
{
    ...
    cls->defineProperty("layout", _SE(js_gfx_PipelineStateInfo_get_layout), _SE(js_gfx_PipelineStateInfo_set_layout));
...
static bool js_gfx_CommandBufferInfo_get_allocator(se::State& s)
{
    cc::gfx::CommandBufferInfo* cobj = (cc::gfx::CommandBufferInfo*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_CommandBufferInfo_get_allocator : Invalid Native Object");
...
SE_BIND_PROP_GET(js_gfx_CommandBufferInfo_get_allocator)

static bool js_gfx_CommandBufferInfo_set_allocator(se::State& s)
{
    const auto& args = s.args();
    cc::gfx::CommandBufferInfo* cobj = (cc::gfx::CommandBufferInfo*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_CommandBufferInfo_set_allocator : Invalid Native Object");

    CC_UNUSED bool ok = true;
    cc::gfx::CommandAllocator* arg0 = nullptr;
    ok &= seval_to_native_ptr(args[0], &arg0);
    SE_PRECONDITION2(ok, false, "js_gfx_CommandBufferInfo_set_allocator : Error processing new value");
    cobj->allocator = arg0;
    return true;
}
SE_BIND_PROP_SET(js_gfx_CommandBufferInfo_set_allocator)
...
bool js_register_gfx_CommandBufferInfo(se::Object* obj)
{
    ...
    cls->defineProperty("allocator", _SE(js_gfx_CommandBufferInfo_get_allocator), _SE(js_gfx_CommandBufferInfo_set_allocator));
...
bool js_register_gfx_GFXObject(se::Object* obj)
{
    ...
    cls->defineProperty("Type", _SE(js_gfx_GFXObject_getType), nullptr);
...
static bool js_gfx_Device_createCommandAllocator(se::State& s)
{
    cc::gfx::Device* cobj = (cc::gfx::Device*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_Device_createCommandAllocator : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cc::gfx::CommandAllocatorInfo* arg0 = nullptr;
        ok &= seval_to_reference(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_gfx_Device_createCommandAllocator : Error processing arguments");
        cc::gfx::CommandAllocator* result = cobj->createCommandAllocator(*arg0);
        ok &= native_ptr_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_gfx_Device_createCommandAllocator : Error processing arguments");
        return true;
    }
...
SE_BIND_FUNC(js_gfx_Device_createCommandAllocator)
...
static bool js_gfx_Device_getCommandAllocator(se::State& s)
{
    cc::gfx::Device* cobj = (cc::gfx::Device*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_Device_getCommandAllocator : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cc::gfx::CommandAllocator* result = cobj->getCommandAllocator();
        ok &= native_ptr_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_gfx_Device_getCommandAllocator : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_PROP_GET(js_gfx_Device_getCommandAllocator)
...
bool js_register_gfx_Device(se::Object* obj)
{
    ...
    cls->defineProperty("commandAllocator", _SE(js_gfx_Device_getCommandAllocator), nullptr);
    ...
    cls->defineFunction("createCommandAllocator", _SE(js_gfx_Device_createCommandAllocator));
...
static bool js_gfx_PipelineLayout_getLayouts(se::State& s)
{
    cc::gfx::PipelineLayout* cobj = (cc::gfx::PipelineLayout*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_PipelineLayout_getLayouts : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= std_vector_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_gfx_PipelineLayout_getLayouts : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_gfx_PipelineLayout_getLayouts)
...
SE_BIND_PROP_GET(js_gfx_PipelineLayout_getDevice)

static bool js_gfx_PipelineLayout_getPushConstantsRanges(se::State& s)
{
    cc::gfx::PipelineLayout* cobj = (cc::gfx::PipelineLayout*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_PipelineLayout_getPushConstantsRanges : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        const std::vector<cc::gfx::PushConstantRange>& result = cobj->getPushConstantsRanges();
        ok &= std_vector_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_gfx_PipelineLayout_getPushConstantsRanges : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_gfx_PipelineLayout_getPushConstantsRanges)
...
bool js_register_gfx_PipelineLayout(se::Object* obj)
{
    ...
    cls->defineProperty("device", _SE(js_gfx_PipelineLayout_getDevice), nullptr);
    cls->defineFunction("getLayouts", _SE(js_gfx_PipelineLayout_getLayouts));
    ...
    cls->defineFunction("getPushConstantsRanges", _SE(js_gfx_PipelineLayout_getPushConstantsRanges));
...
SE_BIND_PROP_GET(js_gfx_PipelineState_getPipelineLayout)
...
bool js_register_gfx_PipelineState(se::Object* obj)
{
    ...
    cls->defineProperty("pipelineLayout", _SE(js_gfx_PipelineState_getPipelineLayout), nullptr);
...
se::Object* __jsb_cc_gfx_CommandAllocator_proto = nullptr;
se::Class* __jsb_cc_gfx_CommandAllocator_class = nullptr;

static bool js_gfx_CommandAllocator_initialize(se::State& s)
{
    cc::gfx::CommandAllocator* cobj = (cc::gfx::CommandAllocator*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_CommandAllocator_initialize : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        cc::gfx::CommandAllocatorInfo* arg0 = nullptr;
        ok &= seval_to_reference(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_gfx_CommandAllocator_initialize : Error processing arguments");
        bool result = cobj->initialize(*arg0);
        ok &= boolean_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_gfx_CommandAllocator_initialize : Error processing arguments");
        return true;
...
SE_BIND_FUNC(js_gfx_CommandAllocator_initialize)

static bool js_gfx_CommandAllocator_destroy(se::State& s)
{
    cc::gfx::CommandAllocator* cobj = (cc::gfx::CommandAllocator*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_CommandAllocator_destroy : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    if (argc == 0) {
        cobj->destroy();
...
SE_BIND_FUNC(js_gfx_CommandAllocator_destroy)

static bool js_gfx_CommandAllocator_getDevice(se::State& s)
{
    cc::gfx::CommandAllocator* cobj = (cc::gfx::CommandAllocator*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_CommandAllocator_getDevice : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cc::gfx::Device* result = cobj->getDevice();
        ok &= native_ptr_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_gfx_CommandAllocator_getDevice : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_gfx_CommandAllocator_getDevice)

SE_DECLARE_FINALIZE_FUNC(js_cc_gfx_CommandAllocator_finalize)

static bool js_gfx_CommandAllocator_constructor(se::State& s)
{
    //#3 cc::gfx::CommandAllocator: is_skip_construtor True
    se::ScriptEngine::getInstance()->evalString("throw new Error(\"cc::gfx::CommandAllocator constructor is skipped\")");
    return false;
}
SE_BIND_CTOR(js_gfx_CommandAllocator_constructor, __jsb_cc_gfx_CommandAllocator_class, js_cc_gfx_CommandAllocator_finalize)



extern se::Object* __jsb_cc_gfx_GFXObject_proto;

static bool js_cc_gfx_CommandAllocator_finalize(se::State& s)
{
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(s.nativeThisObject());
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
...
SE_BIND_FINALIZE_FUNC(js_cc_gfx_CommandAllocator_finalize)

bool js_register_gfx_CommandAllocator(se::Object* obj)
{
    auto cls = se::Class::create("CommandAllocator", obj, __jsb_cc_gfx_GFXObject_proto, _SE(js_gfx_CommandAllocator_constructor));

    cls->defineFunction("initialize", _SE(js_gfx_CommandAllocator_initialize));
    cls->defineFunction("destroy", _SE(js_gfx_CommandAllocator_destroy));
    cls->defineFunction("getDevice", _SE(js_gfx_CommandAllocator_getDevice));
    cls->defineFinalizeFunction(_SE(js_cc_gfx_CommandAllocator_finalize));
    cls->install();
    JSBClassType::registerClass<cc::gfx::CommandAllocator>(cls);

    __jsb_cc_gfx_CommandAllocator_proto = cls->getProto();
    __jsb_cc_gfx_CommandAllocator_class = cls;
...
static bool js_gfx_CommandBuffer_getAllocator(se::State& s)
{
    cc::gfx::CommandBuffer* cobj = (cc::gfx::CommandBuffer*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_gfx_CommandBuffer_getAllocator : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        cc::gfx::CommandAllocator* result = cobj->getAllocator();
        ok &= native_ptr_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_gfx_CommandBuffer_getAllocator : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_gfx_CommandBuffer_getAllocator)
...
bool js_register_gfx_CommandBuffer(se::Object* obj)
{
    ...
    cls->defineFunction("getAllocator", _SE(js_gfx_CommandBuffer_getAllocator));
...
bool register_all_gfx(se::Object* obj)
{
    ...
    js_register_gfx_Binding(ns);
    js_register_gfx_Texture(ns);
    js_register_gfx_Uniform(ns);
    js_register_gfx_PushConstantRange(ns);
    ...
    js_register_gfx_CommandAllocator(ns);
