...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXObjectType *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXObjectType>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXObjectType>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXStatus *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXStatus>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXStatus>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXAPI *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXAPI>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXAPI>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXFeature *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXFeature>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXFeature>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXFormat *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXFormat>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXFormat>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXFormatType *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXFormatType>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXFormatType>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXType *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXType>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXType>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXBufferUsageBit *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXBufferUsageBit>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXBufferUsageBit>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXBufferFlagBit *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXBufferFlagBit>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXBufferFlagBit>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXBufferAccessBit *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXBufferAccessBit>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXBufferAccessBit>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXMemoryUsageBit *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXMemoryUsageBit>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXMemoryUsageBit>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXTextureType *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXTextureType>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXTextureType>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXTextureUsageBit *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXTextureUsageBit>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXTextureUsageBit>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXTextureFlagBit *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXTextureFlagBit>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXTextureFlagBit>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXSampleCount *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXSampleCount>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXSampleCount>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXTextureViewType *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXTextureViewType>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXTextureViewType>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXFilter *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXFilter>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXFilter>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXAddress *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXAddress>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXAddress>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXComparisonFunc *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXComparisonFunc>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXComparisonFunc>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXStencilOp *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXStencilOp>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXStencilOp>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXBlendFactor *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXBlendFactor>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXBlendFactor>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXBlendOp *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXBlendOp>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXBlendOp>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXColorMask *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXColorMask>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXColorMask>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXShaderType *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXShaderType>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXShaderType>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXLoadOp *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXLoadOp>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXLoadOp>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXStoreOp *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXStoreOp>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXStoreOp>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXTextureLayout *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXTextureLayout>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXTextureLayout>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXPipelineBindPoint *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXPipelineBindPoint>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXPipelineBindPoint>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXPrimitiveMode *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXPrimitiveMode>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXPrimitiveMode>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXPolygonMode *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXPolygonMode>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXPolygonMode>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXShadeModel *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXShadeModel>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXShadeModel>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXCullMode *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXCullMode>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXCullMode>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXDynamicState *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXDynamicState>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXDynamicState>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXStencilFace *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXStencilFace>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXStencilFace>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXBindingType *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXBindingType>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXBindingType>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXQueueType *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXQueueType>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXQueueType>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXCommandBufferType *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXCommandBufferType>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXCommandBufferType>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXClearFlagBit *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXClearFlagBit>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXClearFlagBit>(tmp); return true;}
    return false;
}
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXVsyncMode *to, se::Object *ctx)
{
    typedef typename std::underlying_type_t<cocos2d::GFXVsyncMode>  under_type;
    under_type tmp;
    if(sevalue_to_native(from, &tmp, ctx)) { *to = static_cast<cocos2d::GFXVsyncMode>(tmp); return true;}
    return false;
}
...
{
    cocos2d::GFXOffset* cobj = SE_THIS_OBJECT<cocos2d::GFXOffset>(s);
...
static bool js_gfx_GFXOffset_set_x(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->x, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXOffset_set_y(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->y, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXOffset_set_z(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->z, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXOffset * to, se::Object *ctx)
{
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXOffset)", SE_THIS_OBJECT<cocos2d::GFXOffset>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXOffset>(s));
...
{
    cocos2d::GFXRect* cobj = SE_THIS_OBJECT<cocos2d::GFXRect>(s);
...
static bool js_gfx_GFXRect_set_width(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->width, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXRect_set_height(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->height, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXRect * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXRect)", SE_THIS_OBJECT<cocos2d::GFXRect>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXRect>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXRect* cobj = SE_THIS_OBJECT<cocos2d::GFXRect>(s);
...
{
    cocos2d::GFXExtent* cobj = SE_THIS_OBJECT<cocos2d::GFXExtent>(s);
...
static bool js_gfx_GFXExtent_set_depth(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->depth, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXExtent * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXExtent)", SE_THIS_OBJECT<cocos2d::GFXExtent>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXExtent>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXExtent* cobj = SE_THIS_OBJECT<cocos2d::GFXExtent>(s);
...
{
    cocos2d::GFXTextureSubres* cobj = SE_THIS_OBJECT<cocos2d::GFXTextureSubres>(s);
...
static bool js_gfx_GFXTextureSubres_set_baseMipLevel(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->baseMipLevel, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXTextureSubres_set_levelCount(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->levelCount, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXTextureSubres_set_baseArrayLayer(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->baseArrayLayer, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXTextureSubres_set_layerCount(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->layerCount, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXTextureSubres * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXTextureSubres)", SE_THIS_OBJECT<cocos2d::GFXTextureSubres>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXTextureSubres>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXTextureSubres* cobj = SE_THIS_OBJECT<cocos2d::GFXTextureSubres>(s);
...
{
    cocos2d::GFXTextureCopy* cobj = SE_THIS_OBJECT<cocos2d::GFXTextureCopy>(s);
...
static bool js_gfx_GFXTextureCopy_set_srcSubres(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->srcSubres, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXTextureCopy_set_srcOffset(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->srcOffset, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXTextureCopy_set_dstSubres(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->dstSubres, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXTextureCopy_set_dstOffset(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->dstOffset, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXTextureCopy_set_extent(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->extent, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXTextureCopy * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXTextureCopy)", SE_THIS_OBJECT<cocos2d::GFXTextureCopy>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXTextureCopy>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXTextureCopy* cobj = SE_THIS_OBJECT<cocos2d::GFXTextureCopy>(s);
...
{
    cocos2d::GFXBufferTextureCopy* cobj = SE_THIS_OBJECT<cocos2d::GFXBufferTextureCopy>(s);
...
static bool js_gfx_GFXBufferTextureCopy_set_buffOffset(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->buffOffset, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBufferTextureCopy_set_buffStride(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->buffStride, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBufferTextureCopy_set_buffTexHeight(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->buffTexHeight, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBufferTextureCopy_set_texOffset(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->texOffset, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBufferTextureCopy_set_texExtent(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->texExtent, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBufferTextureCopy_set_texSubres(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->texSubres, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXBufferTextureCopy * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
static bool js_gfx_GFXBufferTextureCopy_constructor(se::State& s)
{
    ...
    else if(argc == 6)
    {
        ...
        if (!args[5].isNullOrUndefined()) {
            ok &= sevalue_to_native(args[5], &arg5, nullptr); //is_reference False;
            cobj->texSubres = arg5;
        }
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXBufferTextureCopy)", SE_THIS_OBJECT<cocos2d::GFXBufferTextureCopy>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXBufferTextureCopy>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXBufferTextureCopy* cobj = SE_THIS_OBJECT<cocos2d::GFXBufferTextureCopy>(s);
...
{
    cocos2d::GFXViewport* cobj = SE_THIS_OBJECT<cocos2d::GFXViewport>(s);
...
static bool js_gfx_GFXViewport_set_left(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->left, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXViewport_set_top(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->top, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXViewport_set_minDepth(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->minDepth, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXViewport_set_maxDepth(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->maxDepth, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXViewport * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXViewport)", SE_THIS_OBJECT<cocos2d::GFXViewport>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXViewport>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXViewport* cobj = SE_THIS_OBJECT<cocos2d::GFXViewport>(s);
...
{
    cocos2d::GFXColor* cobj = SE_THIS_OBJECT<cocos2d::GFXColor>(s);
...
static bool js_gfx_GFXColor_set_r(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->r, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXColor_set_g(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->g, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXColor_set_b(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->b, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXColor_set_a(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->a, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXColor * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXColor)", SE_THIS_OBJECT<cocos2d::GFXColor>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXColor>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXColor* cobj = SE_THIS_OBJECT<cocos2d::GFXColor>(s);
...
{
    cocos2d::GFXDeviceInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXDeviceInfo>(s);
...
static bool js_gfx_GFXDeviceInfo_set_windowHandle(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->windowHandle, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDeviceInfo_set_nativeWidth(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->nativeWidth, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDeviceInfo_set_nativeHeight(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->nativeHeight, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXDeviceInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXDeviceInfo)", SE_THIS_OBJECT<cocos2d::GFXDeviceInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXDeviceInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXDeviceInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXDeviceInfo>(s);
...
{
    cocos2d::GFXWindowInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXWindowInfo>(s);
...
static bool js_gfx_GFXWindowInfo_set_title(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->title, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXWindowInfo_get_colorFmt(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->colorFmt, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXWindowInfo_set_colorFmt(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->colorFmt, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXWindowInfo_get_depthStencilFmt(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->depthStencilFmt, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXWindowInfo_set_depthStencilFmt(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->depthStencilFmt, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXWindowInfo_get_isOffscreen(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->isOffscreen, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXWindowInfo_set_isOffscreen(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->isOffscreen, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXWindowInfo_get_isFullscreen(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->isFullscreen, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXWindowInfo_set_isFullscreen(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->isFullscreen, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXWindowInfo_set_vsyncMode(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->vsyncMode, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXWindowInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
    ...
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->colorFmt), ctx);
    }
    json->getProperty("depthStencilFmt", &field);
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->depthStencilFmt), ctx);
    }
    json->getProperty("isOffscreen", &field);
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->isOffscreen), ctx);
    }
    json->getProperty("isFullscreen", &field);
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->isFullscreen), ctx);
    }
...
static bool js_gfx_GFXWindowInfo_constructor(se::State& s)
{
    ...
    else if(argc == 11)
    {
        ...
        if (!args[6].isNullOrUndefined()) {
            ok &= sevalue_to_native(args[6], &arg6, nullptr); //is_reference False;
            cobj->depthStencilFmt = arg6;
        }
        bool arg7;
        if (!args[7].isNullOrUndefined()) {
            ok &= sevalue_to_native(args[7], &arg7, nullptr); //is_reference False;
            cobj->isOffscreen = arg7;
        }
        bool arg8;
        if (!args[8].isNullOrUndefined()) {
            ok &= sevalue_to_native(args[8], &arg8, nullptr); //is_reference False;
            cobj->isFullscreen = arg8;
        }
        cocos2d::GFXVsyncMode arg9;
        if (!args[9].isNullOrUndefined()) {
            ok &= sevalue_to_native(args[9], &arg9, nullptr); //is_reference False;
            cobj->vsyncMode = arg9;
        }
        uintptr_t arg10 = {};
        if (!args[10].isNullOrUndefined()) {
            ok &= sevalue_to_native(args[10], &arg10, nullptr); //is_reference False;
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXWindowInfo)", SE_THIS_OBJECT<cocos2d::GFXWindowInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXWindowInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXWindowInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXWindowInfo>(s);
...
{
    cocos2d::GFXContextInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXContextInfo>(s);
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXContextInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXContextInfo)", SE_THIS_OBJECT<cocos2d::GFXContextInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXContextInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXContextInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXContextInfo>(s);
...
{
    cocos2d::GFXBufferInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXBufferInfo>(s);
...
static bool js_gfx_GFXBufferInfo_set_usage(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->usage, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBufferInfo_set_memUsage(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->memUsage, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBufferInfo_set_stride(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stride, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBufferInfo_set_flags(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->flags, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXBufferInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXBufferInfo)", SE_THIS_OBJECT<cocos2d::GFXBufferInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXBufferInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXBufferInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXBufferInfo>(s);
...
{
    cocos2d::GFXDrawInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXDrawInfo>(s);
...
static bool js_gfx_GFXDrawInfo_set_vertexCount(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->vertexCount, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDrawInfo_set_firstVertex(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->firstVertex, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDrawInfo_set_indexCount(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->indexCount, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDrawInfo_set_firstIndex(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->firstIndex, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDrawInfo_set_vertexOffset(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->vertexOffset, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDrawInfo_set_instanceCount(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->instanceCount, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDrawInfo_set_firstInstance(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->firstInstance, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXDrawInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXDrawInfo)", SE_THIS_OBJECT<cocos2d::GFXDrawInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXDrawInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXDrawInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXDrawInfo>(s);
...
{
    cocos2d::GFXIndirectBuffer* cobj = SE_THIS_OBJECT<cocos2d::GFXIndirectBuffer>(s);
...
static bool js_gfx_GFXIndirectBuffer_set_drawInfos(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->drawInfos, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXIndirectBuffer * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXIndirectBuffer)", SE_THIS_OBJECT<cocos2d::GFXIndirectBuffer>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXIndirectBuffer>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXIndirectBuffer* cobj = SE_THIS_OBJECT<cocos2d::GFXIndirectBuffer>(s);
...
{
    cocos2d::GFXTextureInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXTextureInfo>(s);
...
static bool js_gfx_GFXTextureInfo_set_type(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->type, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXTextureInfo_set_format(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->format, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXTextureInfo_get_arrayLayer(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->arrayLayer, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXTextureInfo_set_arrayLayer(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->arrayLayer, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXTextureInfo_set_mipLevel(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->mipLevel, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXTextureInfo_set_samples(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->samples, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXTextureInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
    ...
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->arrayLayer), ctx);
    }
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXTextureInfo)", SE_THIS_OBJECT<cocos2d::GFXTextureInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXTextureInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXTextureInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXTextureInfo>(s);
...
{
    cocos2d::GFXTextureViewInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXTextureViewInfo>(s);
...
static bool js_gfx_GFXTextureViewInfo_set_texture(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->texture, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXTextureViewInfo_set_baseLevel(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->baseLevel, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXTextureViewInfo_set_baseLayer(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->baseLayer, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXTextureViewInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXTextureViewInfo)", SE_THIS_OBJECT<cocos2d::GFXTextureViewInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXTextureViewInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXTextureViewInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXTextureViewInfo>(s);
...
{
    cocos2d::GFXSamplerInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXSamplerInfo>(s);
...
static bool js_gfx_GFXSamplerInfo_set_minFilter(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->minFilter, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSamplerInfo_set_magFilter(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->magFilter, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSamplerInfo_set_mipFilter(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->mipFilter, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSamplerInfo_set_addressU(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->addressU, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSamplerInfo_set_addressV(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->addressV, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSamplerInfo_set_addressW(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->addressW, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSamplerInfo_set_maxAnisotropy(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->maxAnisotropy, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSamplerInfo_set_cmpFunc(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->cmpFunc, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSamplerInfo_set_borderColor(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->borderColor, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSamplerInfo_set_minLOD(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->minLOD, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSamplerInfo_set_maxLOD(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->maxLOD, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSamplerInfo_set_mipLODBias(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->mipLODBias, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXSamplerInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
static bool js_gfx_GFXSamplerInfo_constructor(se::State& s)
{
    ...
    else if(argc == 13)
    {
        ...
        if (!args[11].isNullOrUndefined()) {
            ok &= sevalue_to_native(args[11], &arg11, nullptr); //is_reference False;
            cobj->maxLOD = arg11;
        }
        float arg12 = {};
        if (!args[12].isNullOrUndefined()) {
            ok &= sevalue_to_native(args[12], &arg12, nullptr); //is_reference False;
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXSamplerInfo)", SE_THIS_OBJECT<cocos2d::GFXSamplerInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXSamplerInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXSamplerInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXSamplerInfo>(s);
...
{
    cocos2d::GFXShaderMacro* cobj = SE_THIS_OBJECT<cocos2d::GFXShaderMacro>(s);
...
static bool js_gfx_GFXShaderMacro_set_macro(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->macro, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXShaderMacro_set_value(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->value, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXShaderMacro * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXShaderMacro)", SE_THIS_OBJECT<cocos2d::GFXShaderMacro>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXShaderMacro>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXShaderMacro* cobj = SE_THIS_OBJECT<cocos2d::GFXShaderMacro>(s);
...
{
    cocos2d::GFXUniform* cobj = SE_THIS_OBJECT<cocos2d::GFXUniform>(s);
...
static bool js_gfx_GFXUniform_set_count(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->count, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXUniform * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXUniform)", SE_THIS_OBJECT<cocos2d::GFXUniform>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXUniform>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXUniform* cobj = SE_THIS_OBJECT<cocos2d::GFXUniform>(s);
...
{
    cocos2d::GFXUniformBlock* cobj = SE_THIS_OBJECT<cocos2d::GFXUniformBlock>(s);
...
static bool js_gfx_GFXUniformBlock_set_binding(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->binding, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXUniformBlock_get_uniforms(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->uniforms, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXUniformBlock_set_uniforms(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->uniforms, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXUniformBlock * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
    ...
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->uniforms), ctx);
    }
    return ok;
}
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXUniformBlock)", SE_THIS_OBJECT<cocos2d::GFXUniformBlock>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXUniformBlock>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXUniformBlock* cobj = SE_THIS_OBJECT<cocos2d::GFXUniformBlock>(s);
...
{
    cocos2d::GFXUniformSampler* cobj = SE_THIS_OBJECT<cocos2d::GFXUniformSampler>(s);
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXUniformSampler * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXUniformSampler)", SE_THIS_OBJECT<cocos2d::GFXUniformSampler>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXUniformSampler>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXUniformSampler* cobj = SE_THIS_OBJECT<cocos2d::GFXUniformSampler>(s);
...
{
    cocos2d::GFXShaderStage* cobj = SE_THIS_OBJECT<cocos2d::GFXShaderStage>(s);
...
static bool js_gfx_GFXShaderStage_set_source(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->source, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXShaderStage_get_macros(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->macros, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXShaderStage_set_macros(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->macros, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXShaderStage * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
    ...
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->macros), ctx);
    }
    return ok;
}
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXShaderStage)", SE_THIS_OBJECT<cocos2d::GFXShaderStage>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXShaderStage>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXShaderStage* cobj = SE_THIS_OBJECT<cocos2d::GFXShaderStage>(s);
...
{
    cocos2d::GFXShaderInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXShaderInfo>(s);
...
static bool js_gfx_GFXShaderInfo_set_stages(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stages, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXShaderInfo_set_blocks(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->blocks, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXShaderInfo_set_samplers(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->samplers, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXShaderInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXShaderInfo)", SE_THIS_OBJECT<cocos2d::GFXShaderInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXShaderInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXShaderInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXShaderInfo>(s);
...
{
    cocos2d::GFXAttribute* cobj = SE_THIS_OBJECT<cocos2d::GFXAttribute>(s);
...
static bool js_gfx_GFXAttribute_set_isNormalized(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->isNormalized, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXAttribute_set_stream(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stream, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXAttribute_set_isInstanced(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->isInstanced, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXAttribute * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXAttribute)", SE_THIS_OBJECT<cocos2d::GFXAttribute>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXAttribute>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXAttribute* cobj = SE_THIS_OBJECT<cocos2d::GFXAttribute>(s);
...
{
    cocos2d::GFXInputAssemblerInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXInputAssemblerInfo>(s);
...
static bool js_gfx_GFXInputAssemblerInfo_set_attributes(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->attributes, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXInputAssemblerInfo_set_vertexBuffers(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->vertexBuffers, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXInputAssemblerInfo_set_indexBuffer(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->indexBuffer, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXInputAssemblerInfo_set_indirectBuffer(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->indirectBuffer, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXInputAssemblerInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXInputAssemblerInfo)", SE_THIS_OBJECT<cocos2d::GFXInputAssemblerInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXInputAssemblerInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXInputAssemblerInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXInputAssemblerInfo>(s);
...
{
    cocos2d::GFXColorAttachment* cobj = SE_THIS_OBJECT<cocos2d::GFXColorAttachment>(s);
...
static bool js_gfx_GFXColorAttachment_set_loadOp(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->loadOp, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXColorAttachment_set_storeOp(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->storeOp, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXColorAttachment_set_sampleCount(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->sampleCount, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXColorAttachment_set_beginLayout(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->beginLayout, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXColorAttachment_set_endLayout(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->endLayout, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXColorAttachment * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXColorAttachment)", SE_THIS_OBJECT<cocos2d::GFXColorAttachment>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXColorAttachment>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXColorAttachment* cobj = SE_THIS_OBJECT<cocos2d::GFXColorAttachment>(s);
...
{
    cocos2d::GFXDepthStencilAttachment* cobj = SE_THIS_OBJECT<cocos2d::GFXDepthStencilAttachment>(s);
...
static bool js_gfx_GFXDepthStencilAttachment_set_depthLoadOp(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->depthLoadOp, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilAttachment_set_depthStoreOp(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->depthStoreOp, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilAttachment_set_stencilLoadOp(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilLoadOp, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilAttachment_set_stencilStoreOp(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilStoreOp, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXDepthStencilAttachment * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXDepthStencilAttachment)", SE_THIS_OBJECT<cocos2d::GFXDepthStencilAttachment>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXDepthStencilAttachment>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXDepthStencilAttachment* cobj = SE_THIS_OBJECT<cocos2d::GFXDepthStencilAttachment>(s);
...
{
    cocos2d::GFXSubPass* cobj = SE_THIS_OBJECT<cocos2d::GFXSubPass>(s);
...
static bool js_gfx_GFXSubPass_set_bindPoint(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->bindPoint, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSubPass_set_inputs(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->inputs, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSubPass_set_colors(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->colors, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSubPass_set_resolves(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->resolves, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSubPass_set_depthStencil(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->depthStencil, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXSubPass_set_preserves(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->preserves, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXSubPass * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXSubPass)", SE_THIS_OBJECT<cocos2d::GFXSubPass>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXSubPass>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXSubPass* cobj = SE_THIS_OBJECT<cocos2d::GFXSubPass>(s);
...
{
    cocos2d::GFXRenderPassInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXRenderPassInfo>(s);
...
static bool js_gfx_GFXRenderPassInfo_set_colorAttachments(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->colorAttachments, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXRenderPassInfo_set_depthStencilAttachment(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->depthStencilAttachment, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXRenderPassInfo_set_subPasses(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->subPasses, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXRenderPassInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXRenderPassInfo)", SE_THIS_OBJECT<cocos2d::GFXRenderPassInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXRenderPassInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXRenderPassInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXRenderPassInfo>(s);
...
{
    cocos2d::GFXFramebufferInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXFramebufferInfo>(s);
...
static bool js_gfx_GFXFramebufferInfo_set_renderPass(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->renderPass, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXFramebufferInfo_get_colorViews(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->colorViews, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXFramebufferInfo_set_colorViews(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->colorViews, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXFramebufferInfo_get_depthStencilView(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->depthStencilView, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXFramebufferInfo_set_depthStencilView(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->depthStencilView, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXFramebufferInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
    ...
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->colorViews), ctx);
    }
    json->getProperty("depthStencilView", &field);
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->depthStencilView), ctx);
    }
    json->getProperty("isOffscreen", &field);
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->isOffscreen), ctx);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXFramebufferInfo)", SE_THIS_OBJECT<cocos2d::GFXFramebufferInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXFramebufferInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXFramebufferInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXFramebufferInfo>(s);
...
{
    cocos2d::GFXBinding* cobj = SE_THIS_OBJECT<cocos2d::GFXBinding>(s);
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXBinding * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXBinding)", SE_THIS_OBJECT<cocos2d::GFXBinding>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXBinding>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXBinding* cobj = SE_THIS_OBJECT<cocos2d::GFXBinding>(s);
...
{
    cocos2d::GFXBindingLayoutInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXBindingLayoutInfo>(s);
...
static bool js_gfx_GFXBindingLayoutInfo_set_bindings(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->bindings, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXBindingLayoutInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXBindingLayoutInfo)", SE_THIS_OBJECT<cocos2d::GFXBindingLayoutInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXBindingLayoutInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXBindingLayoutInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXBindingLayoutInfo>(s);
...
{
    cocos2d::GFXBindingUnit* cobj = SE_THIS_OBJECT<cocos2d::GFXBindingUnit>(s);
...
static bool js_gfx_GFXBindingUnit_set_buffer(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->buffer, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBindingUnit_get_texView(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->texView, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXBindingUnit_set_texView(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->texView, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBindingUnit_get_sampler(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->sampler, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXBindingUnit_set_sampler(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->sampler, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXBindingUnit * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
    ...
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->texView), ctx);
    }
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXBindingUnit)", SE_THIS_OBJECT<cocos2d::GFXBindingUnit>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXBindingUnit>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXBindingUnit* cobj = SE_THIS_OBJECT<cocos2d::GFXBindingUnit>(s);
...
{
    cocos2d::GFXPushConstantRange* cobj = SE_THIS_OBJECT<cocos2d::GFXPushConstantRange>(s);
    SE_PRECONDITION2(cobj, false, "js_gfx_GFXPushConstantRange_get_shaderType : Invalid Native Object");

    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->shaderType, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXPushConstantRange_set_shaderType(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->shaderType, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXPushConstantRange_set_offset(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->offset, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXPushConstantRange * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
    ...
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->shaderType), ctx);
    }
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXPushConstantRange)", SE_THIS_OBJECT<cocos2d::GFXPushConstantRange>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXPushConstantRange>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXPushConstantRange* cobj = SE_THIS_OBJECT<cocos2d::GFXPushConstantRange>(s);
...
{
    cocos2d::GFXPipelineLayoutInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXPipelineLayoutInfo>(s);
    SE_PRECONDITION2(cobj, false, "js_gfx_GFXPipelineLayoutInfo_get_pushConstantsRanges : Invalid Native Object");

    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->pushConstantsRanges, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXPipelineLayoutInfo_set_pushConstantsRanges(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->pushConstantsRanges, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXPipelineLayoutInfo_get_layouts(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->layouts, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXPipelineLayoutInfo_set_layouts(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->layouts, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXPipelineLayoutInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
    ...
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->pushConstantsRanges), ctx);
    }
    json->getProperty("layouts", &field);
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->layouts), ctx);
    }
    return ok;
}
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXPipelineLayoutInfo)", SE_THIS_OBJECT<cocos2d::GFXPipelineLayoutInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXPipelineLayoutInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXPipelineLayoutInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXPipelineLayoutInfo>(s);
...
{
    cocos2d::GFXInputState* cobj = SE_THIS_OBJECT<cocos2d::GFXInputState>(s);
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXInputState * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXInputState)", SE_THIS_OBJECT<cocos2d::GFXInputState>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXInputState>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXInputState* cobj = SE_THIS_OBJECT<cocos2d::GFXInputState>(s);
...
{
    cocos2d::GFXRasterizerState* cobj = SE_THIS_OBJECT<cocos2d::GFXRasterizerState>(s);
...
static bool js_gfx_GFXRasterizerState_set_isDiscard(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->isDiscard, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXRasterizerState_set_polygonMode(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->polygonMode, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXRasterizerState_set_shadeModel(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->shadeModel, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXRasterizerState_set_cullMode(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->cullMode, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXRasterizerState_set_isFrontFaceCCW(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->isFrontFaceCCW, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXRasterizerState_set_depthBias(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->depthBias, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXRasterizerState_set_depthBiasClamp(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->depthBiasClamp, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXRasterizerState_set_depthBiasSlop(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->depthBiasSlop, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXRasterizerState_set_isDepthClip(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->isDepthClip, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXRasterizerState_set_isMultisample(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->isMultisample, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXRasterizerState_set_lineWidth(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->lineWidth, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXRasterizerState * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXRasterizerState)", SE_THIS_OBJECT<cocos2d::GFXRasterizerState>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXRasterizerState>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXRasterizerState* cobj = SE_THIS_OBJECT<cocos2d::GFXRasterizerState>(s);
...
{
    cocos2d::GFXDepthStencilState* cobj = SE_THIS_OBJECT<cocos2d::GFXDepthStencilState>(s);
...
static bool js_gfx_GFXDepthStencilState_set_depthTest(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->depthTest, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_depthWrite(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->depthWrite, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_depthFunc(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->depthFunc, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilTestFront(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilTestFront, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilFuncFront(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilFuncFront, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilReadMaskFront(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilReadMaskFront, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilWriteMaskFront(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilWriteMaskFront, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilFailOpFront(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilFailOpFront, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilZFailOpFront(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilZFailOpFront, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilPassOpFront(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilPassOpFront, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilRefFront(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilRefFront, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilTestBack(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilTestBack, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilFuncBack(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilFuncBack, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilReadMaskBack(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilReadMaskBack, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilWriteMaskBack(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilWriteMaskBack, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilFailOpBack(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilFailOpBack, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilZFailOpBack(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilZFailOpBack, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilPassOpBack(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilPassOpBack, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXDepthStencilState_set_stencilRefBack(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->stencilRefBack, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXDepthStencilState * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
static bool js_gfx_GFXDepthStencilState_constructor(se::State& s)
{
    ...
    else if(argc == 19)
    {
        ...
        if (!args[13].isNullOrUndefined()) {
            ok &= sevalue_to_native(args[13], &arg13, nullptr); //is_reference False;
            cobj->stencilReadMaskBack = arg13;
        }
        unsigned int arg14 = {};
        if (!args[14].isNullOrUndefined()) {
            ok &= sevalue_to_native(args[14], &arg14, nullptr); //is_reference False;
            cobj->stencilWriteMaskBack = arg14;
        }
        cocos2d::GFXStencilOp arg15;
        if (!args[15].isNullOrUndefined()) {
            ok &= sevalue_to_native(args[15], &arg15, nullptr); //is_reference False;
            cobj->stencilFailOpBack = arg15;
        }
        cocos2d::GFXStencilOp arg16;
        if (!args[16].isNullOrUndefined()) {
            ok &= sevalue_to_native(args[16], &arg16, nullptr); //is_reference False;
            cobj->stencilZFailOpBack = arg16;
        }
        cocos2d::GFXStencilOp arg17;
        if (!args[17].isNullOrUndefined()) {
            ok &= sevalue_to_native(args[17], &arg17, nullptr); //is_reference False;
            cobj->stencilPassOpBack = arg17;
        }
        unsigned int arg18 = {};
        if (!args[18].isNullOrUndefined()) {
            ok &= sevalue_to_native(args[18], &arg18, nullptr); //is_reference False;
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXDepthStencilState)", SE_THIS_OBJECT<cocos2d::GFXDepthStencilState>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXDepthStencilState>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXDepthStencilState* cobj = SE_THIS_OBJECT<cocos2d::GFXDepthStencilState>(s);
...
{
    cocos2d::GFXBlendTarget* cobj = SE_THIS_OBJECT<cocos2d::GFXBlendTarget>(s);
...
static bool js_gfx_GFXBlendTarget_set_blend(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->blend, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBlendTarget_set_blendSrc(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->blendSrc, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBlendTarget_set_blendDst(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->blendDst, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBlendTarget_set_blendEq(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->blendEq, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBlendTarget_set_blendSrcAlpha(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->blendSrcAlpha, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBlendTarget_set_blendDstAlpha(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->blendDstAlpha, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBlendTarget_set_blendAlphaEq(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->blendAlphaEq, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBlendTarget_set_blendColorMask(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->blendColorMask, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXBlendTarget * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXBlendTarget)", SE_THIS_OBJECT<cocos2d::GFXBlendTarget>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXBlendTarget>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXBlendTarget* cobj = SE_THIS_OBJECT<cocos2d::GFXBlendTarget>(s);
...
{
    cocos2d::GFXBlendState* cobj = SE_THIS_OBJECT<cocos2d::GFXBlendState>(s);
...
static bool js_gfx_GFXBlendState_set_isA2C(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->isA2C, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBlendState_set_isIndepend(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->isIndepend, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBlendState_set_blendColor(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->blendColor, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXBlendState_set_targets(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->targets, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXBlendState * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXBlendState)", SE_THIS_OBJECT<cocos2d::GFXBlendState>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXBlendState>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXBlendState* cobj = SE_THIS_OBJECT<cocos2d::GFXBlendState>(s);
...
{
    cocos2d::GFXPipelineStateInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXPipelineStateInfo>(s);
...
static bool js_gfx_GFXPipelineStateInfo_set_primitive(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->primitive, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXPipelineStateInfo_set_shader(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->shader, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXPipelineStateInfo_set_inputState(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->inputState, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXPipelineStateInfo_set_rasterizerState(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->rasterizerState, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXPipelineStateInfo_set_depthStencilState(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->depthStencilState, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXPipelineStateInfo_set_blendState(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->blendState, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXPipelineStateInfo_set_dynamicStates(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->dynamicStates, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXPipelineStateInfo_set_layout(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->layout, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXPipelineStateInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXPipelineStateInfo)", SE_THIS_OBJECT<cocos2d::GFXPipelineStateInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXPipelineStateInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXPipelineStateInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXPipelineStateInfo>(s);
...
{
    cocos2d::GFXCommandBufferInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXCommandBufferInfo>(s);
    SE_PRECONDITION2(cobj, false, "js_gfx_GFXCommandBufferInfo_get_allocator : Invalid Native Object");

    CC_UNUSED bool ok = true;
    se::Value jsret;
    ok &= nativevalue_to_se(cobj->allocator, jsret, s.thisObject() /*ctx*/);
    s.rval() = jsret;
    return true;
}
...
static bool js_gfx_GFXCommandBufferInfo_set_allocator(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->allocator, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXCommandBufferInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
    ...
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->allocator), ctx);
    }
    json->getProperty("type", &field);
    if(!field.isNullOrUndefined()) {
        ok &= sevalue_to_native(field, &(to->type), ctx);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXCommandBufferInfo)", SE_THIS_OBJECT<cocos2d::GFXCommandBufferInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXCommandBufferInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXCommandBufferInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXCommandBufferInfo>(s);
...
{
    cocos2d::GFXQueueInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXQueueInfo>(s);
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXQueueInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXQueueInfo)", SE_THIS_OBJECT<cocos2d::GFXQueueInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXQueueInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXQueueInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXQueueInfo>(s);
...
{
    cocos2d::GFXFormatInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXFormatInfo>(s);
...
static bool js_gfx_GFXFormatInfo_set_hasAlpha(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->hasAlpha, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXFormatInfo_set_hasDepth(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->hasDepth, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXFormatInfo_set_hasStencil(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->hasStencil, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXFormatInfo_set_isCompressed(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->isCompressed, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXFormatInfo * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXFormatInfo)", SE_THIS_OBJECT<cocos2d::GFXFormatInfo>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXFormatInfo>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXFormatInfo* cobj = SE_THIS_OBJECT<cocos2d::GFXFormatInfo>(s);
...
{
    cocos2d::GFXMemoryStatus* cobj = SE_THIS_OBJECT<cocos2d::GFXMemoryStatus>(s);
...
static bool js_gfx_GFXMemoryStatus_set_bufferSize(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->bufferSize, s.thisObject()); //is_reference False;
...
static bool js_gfx_GFXMemoryStatus_set_textureSize(se::State& s)
{
    ...
    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->textureSize, s.thisObject()); //is_reference False;
...
template<>
bool sevalue_to_native(const se::Value &from, cocos2d::GFXMemoryStatus * to, se::Object *ctx)
{
    assert(from.isObject());
    se::Object *json = from.toObject();
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXMemoryStatus)", SE_THIS_OBJECT<cocos2d::GFXMemoryStatus>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXMemoryStatus>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXMemoryStatus* cobj = SE_THIS_OBJECT<cocos2d::GFXMemoryStatus>(s);
...
{
    cocos2d::GFXObject* cobj = SE_THIS_OBJECT<cocos2d::GFXObject>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXObject)", SE_THIS_OBJECT<cocos2d::GFXObject>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXObject>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXObject* cobj = SE_THIS_OBJECT<cocos2d::GFXObject>(s);
...
{
    cocos2d::GFXDevice* cobj = SE_THIS_OBJECT<cocos2d::GFXDevice>(s);
...
{
    cocos2d::GFXWindow* cobj = SE_THIS_OBJECT<cocos2d::GFXWindow>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXWindow)", SE_THIS_OBJECT<cocos2d::GFXWindow>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXWindow>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXWindow* cobj = SE_THIS_OBJECT<cocos2d::GFXWindow>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXBuffer)", SE_THIS_OBJECT<cocos2d::GFXBuffer>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXBuffer>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXBuffer* cobj = SE_THIS_OBJECT<cocos2d::GFXBuffer>(s);
...
{
    cocos2d::GFXTexture* cobj = SE_THIS_OBJECT<cocos2d::GFXTexture>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXTexture)", SE_THIS_OBJECT<cocos2d::GFXTexture>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXTexture>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXTexture* cobj = SE_THIS_OBJECT<cocos2d::GFXTexture>(s);
...
{
    cocos2d::GFXTextureView* cobj = SE_THIS_OBJECT<cocos2d::GFXTextureView>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXTextureView)", SE_THIS_OBJECT<cocos2d::GFXTextureView>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXTextureView>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXTextureView* cobj = SE_THIS_OBJECT<cocos2d::GFXTextureView>(s);
...
{
    cocos2d::GFXSampler* cobj = SE_THIS_OBJECT<cocos2d::GFXSampler>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXSampler)", SE_THIS_OBJECT<cocos2d::GFXSampler>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXSampler>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXSampler* cobj = SE_THIS_OBJECT<cocos2d::GFXSampler>(s);
...
{
    cocos2d::GFXShader* cobj = SE_THIS_OBJECT<cocos2d::GFXShader>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXShader)", SE_THIS_OBJECT<cocos2d::GFXShader>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXShader>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXShader* cobj = SE_THIS_OBJECT<cocos2d::GFXShader>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXInputAssembler)", SE_THIS_OBJECT<cocos2d::GFXInputAssembler>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXInputAssembler>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXInputAssembler* cobj = SE_THIS_OBJECT<cocos2d::GFXInputAssembler>(s);
...
{
    cocos2d::GFXRenderPass* cobj = SE_THIS_OBJECT<cocos2d::GFXRenderPass>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXRenderPass)", SE_THIS_OBJECT<cocos2d::GFXRenderPass>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXRenderPass>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXRenderPass* cobj = SE_THIS_OBJECT<cocos2d::GFXRenderPass>(s);
...
{
    cocos2d::GFXFramebuffer* cobj = SE_THIS_OBJECT<cocos2d::GFXFramebuffer>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXFramebuffer)", SE_THIS_OBJECT<cocos2d::GFXFramebuffer>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXFramebuffer>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXFramebuffer* cobj = SE_THIS_OBJECT<cocos2d::GFXFramebuffer>(s);
...
{
    cocos2d::GFXBindingLayout* cobj = SE_THIS_OBJECT<cocos2d::GFXBindingLayout>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXBindingLayout)", SE_THIS_OBJECT<cocos2d::GFXBindingLayout>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXBindingLayout>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXBindingLayout* cobj = SE_THIS_OBJECT<cocos2d::GFXBindingLayout>(s);
...
{
    cocos2d::GFXPipelineLayout* cobj = SE_THIS_OBJECT<cocos2d::GFXPipelineLayout>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXPipelineLayout)", SE_THIS_OBJECT<cocos2d::GFXPipelineLayout>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXPipelineLayout>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXPipelineLayout* cobj = SE_THIS_OBJECT<cocos2d::GFXPipelineLayout>(s);
...
{
    cocos2d::GFXPipelineState* cobj = SE_THIS_OBJECT<cocos2d::GFXPipelineState>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXPipelineState)", SE_THIS_OBJECT<cocos2d::GFXPipelineState>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXPipelineState>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXPipelineState* cobj = SE_THIS_OBJECT<cocos2d::GFXPipelineState>(s);
...
{
    cocos2d::GFXCommandAllocator* cobj = SE_THIS_OBJECT<cocos2d::GFXCommandAllocator>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXCommandAllocator)", SE_THIS_OBJECT<cocos2d::GFXCommandAllocator>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXCommandAllocator>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXCommandAllocator* cobj = SE_THIS_OBJECT<cocos2d::GFXCommandAllocator>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXCommandBuffer)", SE_THIS_OBJECT<cocos2d::GFXCommandBuffer>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXCommandBuffer>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXCommandBuffer* cobj = SE_THIS_OBJECT<cocos2d::GFXCommandBuffer>(s);
...
{
    cocos2d::GFXQueue* cobj = SE_THIS_OBJECT<cocos2d::GFXQueue>(s);
...
{
    CCLOGINFO("jsbindings: finalizing JS object %p (cocos2d::GFXQueue)", SE_THIS_OBJECT<cocos2d::GFXQueue>(s););
    auto iter = se::NonRefNativePtrCreatedByCtorMap::find(SE_THIS_OBJECT<cocos2d::GFXQueue>(s));
    if (iter != se::NonRefNativePtrCreatedByCtorMap::end())
    {
        se::NonRefNativePtrCreatedByCtorMap::erase(iter);
        cocos2d::GFXQueue* cobj = SE_THIS_OBJECT<cocos2d::GFXQueue>(s);
