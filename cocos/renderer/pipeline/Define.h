...
struct CC_DLL UBOGlobal : public Object {
    ...
    static constexpr uint GLOBAL_FOG_COLOR_OFFSET = UBOGlobal::NATIVE_SIZE_OFFSET + 4;
...
struct CC_DLL UBOCamera : public Object {
    static constexpr uint SCREEN_SCALE_OFFSET = 0;
    ...
    static constexpr uint MAT_VIEW_OFFSET = UBOCamera::AMBIENT_GROUND_OFFSET + 4;
    ...
    static constexpr uint COUNT = UBOCamera::CAMERA_POS_OFFSET + 4;
